<?php
ob_start();
require_once "assets\db_details\db.php";
...
$sql = "SELECT * FROM users WHERE type = 1;"; //change it to admin type
  ...
  <body>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <h3 class="box-title m-b-0">Administrators( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
