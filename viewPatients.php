...
$sql = "SELECT * FROM users WHERE type = 2;"; //change it to patients type
  ...
  <body>
    ...
    >
      ...
      <div class="page-wrapper">
        ...
        <h3 class="box-title m-b-0">Patients ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
