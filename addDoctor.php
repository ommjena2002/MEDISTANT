...
if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
    ...
    $sql = "INSERT INTO users (username, password, type, email) VALUES (:username, :password, 3, :email)";
    ...
    >
            ...
            <ul id="sidebarnav" class="pt-4">
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    <a href="viewDoctor.php" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu">View Doctors</span></a
                    >
                  </li>
                </ul>
              </li>
              ...
              <li class="sidebar-item">
                ...
                <ul aria-expanded="false" class="collapse first-level">
                  ...
                  <li class="sidebar-item">
                    <a href="viewAdmin.php" class="sidebar-link"
                      ><i class="mdi mdi-all-inclusive"></i
      ...
      <div class="page-wrapper">
        ...
        <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Add New Doctor Profile</h3>
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon mx-2"><i class="ti-user"></i></div>
                                                <input type="text" name="username" class="form-control" id="exampleInputuname" placeholder="Username"> </div>
                                        </div>
            
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Email address</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="ti-email mx-2"></i></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon mx-2"><i class="ti-lock"></i></div>
